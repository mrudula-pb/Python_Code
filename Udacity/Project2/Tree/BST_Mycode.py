...
class Tree:
    ...
    def diameter_of_binary_tree(root):
        return root.diameter_of_binary_tree_func(root)
    ...
    def diameter_of_binary_tree_func(root):
        ...
        left_height, left_diameter = root.diameter_of_binary_tree_func(root.left)
        right_height, right_diameter = root.diameter_of_binary_tree_func(root.right)
...
tree.insert(4)
tree.insert(2)
#print(f""" Serach for 2: {tree.search(2)}
            #Search for 8: {tree.search(8)}""")

btree = BinaryTreeNode()
r = btree.convert_arr_to_binary_tree([1,2,3,4,5])
output = btree.diameter_of_binary_tree(r)
print(output)
